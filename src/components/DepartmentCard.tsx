...
const DepartmentCard: React.FC<DepartmentCardProps> = ({ department, onClick }) => {
  const IconComponent = Icons[department.icon as keyof typeof Icons] as React.ComponentType<any>;
      ...
      <div className="p-6">
        <div className="flex items-center space-x-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{department.officials.length} officials</p>
          </div>
        </div>
