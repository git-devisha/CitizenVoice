...
import { Clock, MapPin, AlertCircle, CheckCircle, XCircle, Eye } from 'lucide-react';
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(complaint.status)} flex items-center space-x-1`}>
